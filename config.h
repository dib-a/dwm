...
static const char *reboot[]  = { "st","reboot", NULL };
static const char *shutdown[]  = { "st","poweroff", NULL };
static const char *firefox[]  = { "firefox", NULL };
static const char *ranger[]  = { "st","ranger", NULL };
static const char *raiseVolume[]  = { "pulsemixer", "--change-volume", "+10", NULL };
static const char *lowerVolume[]  = { "pulsemixer", "--change-volume", "-10", NULL };
...
/*
static const char *brightnessUp[]  = { "st","xbacklight -inc 10", NULL };
static const char *brightnessDown[]  = { "st","xbacklight -dec 10", NULL };
*/
