...
static const char *fonts[]          = { var_font };
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", var_font, "-nb", col_bg, "-nf", col_fg, "-sb", col_fg, "-sf", col_bg, NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_r,      					spawn,          SHCMD("kitty ranger")},
